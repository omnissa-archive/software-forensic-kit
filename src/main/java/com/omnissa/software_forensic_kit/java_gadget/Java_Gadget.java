...
public class Java_Gadget{
	...
	public static void printUsage(HelpFormatter formatter, Options options) {
		String footer = "Example Usage:\r\n" + 
        		"	>java -cp software_forensic_kit.jar com.omnissa.software_forensic_kit.java_gadget.Java_Gadget -s \"ExampleClass:functionA\" -hm -rp my.class.path.  /home/test/testfile.jar\r\n" + 
        		"	or using wildcards * for filter\r\n" + 
        		"	>java -cp software_forensic_kit.jar com.omnissa.software_forensic_kit.java_gadget.Java_Gadget  -s \"ExampleClass*functionA\" -pp -rp my.class.path.  /var/test/example.jar ";
